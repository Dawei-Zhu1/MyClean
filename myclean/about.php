...
<div class="container">
    <section class="about">
        <h2>Who We Are</h2>
        <p>MyClean is a digital platform dedicated to connecting customers with reliable, professional cleaning service
            providers. Whether you’re a busy homeowner or a commercial office in need of regular cleaning, MyClean makes
            booking easy and efficient.</p>

        <h2>Our Mission</h2>
        <p>We strive to simplify the process of hiring trusted cleaners by offering a platform that prioritizes
            transparency, convenience, and top-quality service. We’re committed to creating clean, healthy spaces for
            all.</p>
